 ...
 */
public class CartItemPost extends AsyncTask<String,Void,ResponseHome> {
    private ProgressDialog dialog;
    private final static String URL = Keys.BASE_URL_ARABIC + "cart";
    private OnResponseResult callback;
    private Context context;
    public CartItemPost(Context context, OnResponseResult cb) {
